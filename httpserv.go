...
fmt.Println(o.Frontpage(geddit.DefaultPopularity, subOpts))
...
//fmt.Fprintf(w, o.Frontpage(geddit.DefaultPopularity, subOpts)) // Vi skriver dette til "w" som er http.Responewriter.
}